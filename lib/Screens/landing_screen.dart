                  ...
                  Container(
                    child: Column(
                      children: [
                        ...
                        AppText(text: 'Open an account', color: Colors.white, size: 18, ),
                      ],
                    ),
                  ),
                  Spacer(),
                  ...
                  Container(
                    child: Column(
                      children: [
                        ...
                        AppText(text: 'Apply for overdraft', color: Colors.white, size: 18, ),
                      ],
                    ),
                  ),
                ],
                ...
                children: [
                  Container(
                    child: Column(
                      children: [
                        landingButtonLoan(Colors.green, 'Sign In', Colors.white, context, widget.token),
                        AppText(text: 'Apply for loan', color: Colors.white, size: 18, ),
                      ],
                    ),
                  ),
                  Spacer(),
                  ...
                  Container(
                    child: Column(
                      children: [
                        ...
                        AppText(text: 'Check balance', color: Colors.white, size: 18, ),
                      ],
                    ),
                  ),
                ],
